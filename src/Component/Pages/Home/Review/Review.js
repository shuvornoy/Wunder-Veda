...
import "./Review.css";
import image from "../../../../assets/review/Ellipss.png";
...
const Review = () => {
  ...
  // console.log(text.testimonials, "dfgdyfgd");
    ...
    <div className="review xl:h-[466px] lg:h-[500px] md:h-[467px] h-[630px]">
      <div className="carousel xl:w-[1280px] w-full mx-auto ">
        ...
        <Swiper
          ...
          className="mySwiper"
        >
          {text?.testimonials?.map((test, index) => (
            <SwiperSlide>
              <div className="relative w-full xl:mt-[113px] md:mt-[120px] mt-[260px] left-[70px] md:left-0">
                <div className="xl:w-[778px] md:w-[500px] w-[343px] mx-auto xl:h-[220px] md:h-[250px] h-[293px] bg-[#FFFFFF] rounded-[13px] border-[1px] border-[#FFFFFF] relative text-center ">
                  <h2 className="xl:mt-[57px] mt-[40px] mx-auto xl:text-[24px] text-[27px] xl:leading-[30px] leading-[42px] xl:font-normal font-bold libreNormal w-[228px]">
                    {test.name}
                  </h2>
                  <p className="mt-[9px] text-[16px] xl:leading-[24px] leading-[22px] font-normal montserratNormal xl:w-[730px] md:w-[480px] w-[314px] mx-auto">
                ...
                <div>
                  <img
                    className="absolute left-0 xl:ml-[593px] lg:ml-[465px] md:ml-[350px] ml-[153px] w-[80px] h-[80px] xl:mt-[-260px] mt-[-58px]"
                    src={image}
                    alt="img"
                  />
                </div>
