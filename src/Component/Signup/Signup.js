...
const Signup = () => {
    ...
    return (
        <div class="min-h-screen flex items-center justify-center mx-auto md:mt-[123px]">
        <div class=" lg:w-[768px] md:w-[650px] w-full lg:h-[906px] relative z-[1] ">
            <div class="bg-[#FFEFD1] py-10 px-8 shadow-md w-full h-full  md:border-[1px] border-[#1e281980]">
                ...
                <form className='xl:mt-[42px]'>
                    <div class="mb-4 mt-4 lg:flex md:flex  block gap-[19px] justify-center items-center">
                        <label class="block text-gray-700 text-[18px] font-[400] mb-2 w-[140px] nunitoNormal" for="username">User name</label>
                        <input class="border border-[#1E2819] rounded-full lg:w-[408px] md:w-[408px] w-full h-[50px] py-2 px-[36px]" type="text" id="username"
                            placeholder="username" />
                    </div>
                    <div class=" lg:flex md:flex  block gap-[19px] justify-center items-center mt-[30px]">
                        <label class="block text-gray-700 text-[18px] font-[400] mb-2 w-[140px] nunitoNormal" for="password">Email</label>
                        ...
                        <div class=" lg:flex md:flex  block gap-[19px] justify-center items-center mt-[30px]">
                            ...
                            <PhoneInput  className="border border-[#1E2819] rounded-full lg:w-[408px] md:w-[408px] w-full h-[50px] py-2 px-[36px] bg-white" type="text" id="number"
                         ...
                         {/* <input  className="border border-[#1E2819] rounded-full lg:w-[408px] md:w-[408px] w-full h-[50px] py-2 px-[36px]" type="password" id="number"
                            placeholder=" Phone Number" /> */}
                    </div>
                    <div class=" lg:flex md:flex  block gap-[19px] justify-center items-center mt-[30px]">
                        <label class="block text-gray-700 text-[18px] font-[400] mb-2 w-[140px] nunitoNormal" for="password">Password</label>
                         <input  class="border border-[#1E2819] rounded-full lg:w-[408px] md:w-[408px] w-full h-[50px] py-2 px-[36px]" type="password" id="password"
                                placeholder=" password" />
                            <img className='w-[16px] h-[12px] absolute lg:right-[135px] md:right-[75px] right-[52px] mt-[-30px] md:mt-0' src={img10} alt="img10" />
                    </div>
                    <div class=" lg:flex md:flex block gap-[19px] justify-center items-center mt-[30px]">
                        <label class="block text-gray-700 text-[17px] font-[400] mb-2 w-[140px] nunitoNormal" for="password">Confirm Password</label>
                         <input  class="border border-[#1E2819] rounded-full lg:w-[408px] md:w-[408px] w-full h-[50px] py-2 px-[36px]" type="password" id="password"
        ...
        <img src={img1} alt="img" className='absolute lg:mt-[-250px] lg:ml-[980px] md:mt-[-50px] md:ml-[700px] w-[92px] h-[90px] hidden lg:block' />
       <img src={img2} alt="img" className='absolute lg:mt-[300px] lg:mr-[800px] md:mt-[600px] md:mr-[600px] w-[184px] h-[153px] z-[1] hidden lg:block' />
        <img src={img3} alt="img"  className='absolute ml-[-850px] w-[534px] h-[574px]  md:hidden lg:block'/>
         <img src={img4} alt="img"  className='absolute mt-[345px] mr-[870px] w-[200px] h-[258px] md:hidden lg:block '/>
         <img src={img5} alt="img" className='absolute lg:mt-[750px] lg:ml-[800px] md:mt-[650px]  md:ml-[650px] lg:w-[147px] md:w-[147px] h-[136px] z-[1] hidden lg:block' />
        <img src={img6} alt="img" className='absolute mt-[-10px] ml-[870px] w-[280px] h-[186px] z-[-1] hidden lg:block lg:w-[279px] lg:h-[185px]' />
          <img src={img7} alt="img"  className='absolute lg:mt-[-850px] md:mt-[-600px]  lg:mr-[450px] md:mr-[350px]'/> 
