...
const Login = () => {
    return (
        ...
        <div class=" lg:w-[768px] md:w-[650px] w-full lg:h-[704px] relative z-[1] ">
            <div class="bg-[#FFEFD1] py-10 px-8 shadow-md w-full h-full  md:border-[1px] border-[#1e281980]">
                ...
                <form>
                    ...
                    <div class="flex justify-center">
                        ...
                        <Link to='/forgot'>
                         <p className='text-end md:mr-16 mt-4 text-[16px] font-bold alegreyaBold'>Forgot Password?</p>
                        </Link>
                </form>
       ...
       <img src={img2} alt="img" className='absolute lg:mt-[600px] lg:mr-[800px] md:mt-[600px] md:mr-[600px] w-[184px] h-[153px] z-[1] md:block lg:block hidden' />
        <img src={img3} alt="img"  className='absolute ml-[-850px] w-[534px] h-[574px]  md:hidden lg:block'/>
         ...
         <img src={img5} alt="img" className='absolute lg:mt-[750px]  lg:ml-[800px] md:mt-[650px]  md:ml-[650px] lg:w-[147px] md:w-[147px] h-[136px] z-[1] md:block lg:block hidden' />
